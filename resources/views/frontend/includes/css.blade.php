...
<link rel="stylesheet" href="{{ asset('frontend') }}/assets/plugins/venobox/css/venobox.min.css">
<link rel="stylesheet" href="{{ asset('frontend') }}/assets/plugins/aos/css/aos.css">
